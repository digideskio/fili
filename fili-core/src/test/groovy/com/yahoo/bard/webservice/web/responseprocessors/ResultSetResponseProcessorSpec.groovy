...
class ResultSetResponseProcessorSpec extends Specification {
    ...
    def setup() {
        ...
        groupByQuery.getDataSource() >> new TableDataSource(new StrictPhysicalTable("table_name", DAY.buildZonedTimeGrain(DateTimeZone.UTC), [] as Set, ["dimension1":"dimension1"], Mock(DataSourceMetadataService)))
